...
class GameSettings: ObservableObject, Codable, Equatable {
    ...
    // Debug Configuration
    @Published var showDebugInfo: Bool = true // Enable debug overlays by default
